...
function lint {
    ...
    for pkg in $non_vendor_pkgs; do
        ...
        set +e
        go_lint_files=$(ls "$dir" | grep -E "\.go$" | grep -vE "_test.go$"| sed -e "s|^|$dir/|" | xargs grep -L '// Code generated by "stringer')
        go_lint_test_files=$(ls "$dir" | grep -E "\.go$" | grep -E "_test.go$"| sed -e "s|^|$dir/|" | xargs grep -L '// Code generated by "stringer')
        set -e
        golint -set_exit_status $go_lint_files
        golint -set_exit_status $go_lint_test_files
    done
